...
##	@protoc -I=. -I=${GOPATH}/src --go-http_out=. examples/http/hello.proto --go-http_opt=module="github.com/yamakiller/glacier-toolchain"
...
gen: # Generate code
	...
	@protoc-go-inject-tag -input=pb/event/*.pb.go
