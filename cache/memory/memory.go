...
// NewCache new a redis cache instance
...
// PutWithTTL 指定TTL
func (c *Cache) PutWithTTL(key string, val interface{}, _ time.Duration) error {
...
// Incr 等待实现
func (c *Cache) Incr(_ string) error {
	return errors.New("not implement")
}

// Decr 等待实现
func (c *Cache) Decr(_ string) error {
	return errors.New("not implement")
}
...
// ListKey todo
func (c *Cache) ListKey(_ *cache.ListKeyRequest) (*cache.ListKeyResponse, error) {
	var ks []string
