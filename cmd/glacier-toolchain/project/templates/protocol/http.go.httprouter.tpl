...
import (
	...
	"github.com/yamakiller/glacier-toolchain/http/middleware/access"
	"github.com/yamakiller/glacier-toolchain/http/middleware/cors"
	"github.com/yamakiller/glacier-toolchain/http/middleware/recovery"
	"github.com/yamakiller/glacier-toolchain/http/router"
	"github.com/yamakiller/glacier-toolchain/http/router/httprouter"
...
func NewHTTPService() *HTTPService {
	...
	r.Use(access.NewWithLogger(zap.L().Named("AccessLog")))
	r.Use(cors.AllowAll())
	r.EnableAPIRoot()
	r.Auth(false)
...
func (s *HTTPService) Start() error {
	// 装置子服务路由
	service.LoadHttpService(s.PathPrefix(), s.r)
	// 注册路由条目
	s.RegistryEndpoint()
	// 启动 HTTP服务
