...
const (
	...
	// ClientIDHeader 客户端头ID
	ClientIDHeader = "client-id"
	// ClientSecretHeader 客户端头Secret
	ClientSecretHeader = "client-secret"
	// OauthTokenHeader 客户端头 x-oauth-token
	OauthTokenHeader = "x-oauth-token"
	// RealIPHeader 客户端头 x-real-ip
	RealIPHeader = "x-real-ip"
	// UserAgentHeader 客户端头 user-agent
	UserAgentHeader = "user-agent"
	// RequestID 客户端头 x-request-id
	RequestID = "x-request-id"
)

// NewGrpcInCtx 实例一个GRPC上下文
...
// NewGrpcInCtxFromHTTPRequest 从上下文中获取Token
