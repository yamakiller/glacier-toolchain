...
// 用于其他模块自定义异常
func NewAPIException(namespace string,
	code int,
	reason,
	format string,
	a ...interface{}) IAPIException {
	// 0表示正常状态, 但是要排除变量的零值
	if code == 0 {
		code = -1
	}
